...
#define USE_UART2_DRIVER    (0)
#define USE_UART3_DRIVER    (0)
...
/* 串口1缓冲区配置 */
#define UART1_TX_BUFF_SIZE     512   /* 串口1发送缓冲区大小 */
#define UART1_RX_BUFF_SIZE     512   /* 串口1接收缓冲区大小 */
#define UART1_RX_MAX           128   /* 串口1一次能接收的数据大小 */
