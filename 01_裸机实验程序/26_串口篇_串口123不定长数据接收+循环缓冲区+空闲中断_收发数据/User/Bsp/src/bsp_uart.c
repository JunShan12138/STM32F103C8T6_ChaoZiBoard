...
static uart_ctrl_t uart1;
static uart_ctrl_t uart2;
static uart_ctrl_t uart3;
...
void uart2_tx_process(void)
{
    ...
    if ((uart2.tx_in != uart2.tx_out) && (uart2.tx_state == 0))
    {
        ...
        HAL_UART_Transmit_IT(&uart2.uart, uart2.tx_out->start, len);
...
void uart3_tx_process(void)
{
    ...
    if ((uart3.tx_in != uart3.tx_out) && (uart3.tx_state == 0))
    {
        ...
        HAL_UART_Transmit_IT(&uart3.uart, uart3.tx_out->start, len);
...
void uart2_init(uint32_t baud)
{
    ...
    HAL_UART_Receive_IT(&uart2.uart, uart2.rx_in->start, UART2_RX_MAX);
}
...
void uart3_init(uint32_t baud)
{
    ...
    HAL_UART_Receive_IT(&uart3.uart, uart3.rx_in->start, UART3_RX_MAX);
}
...
void USART2_IRQHandler(void)
{
    ...
    if (__HAL_UART_GET_FLAG(&uart2.uart, UART_FLAG_IDLE))
    {
        ...
        uart2.rx_count += (UART2_RX_MAX - uart2.uart.RxXferCount);
...
void USART3_IRQHandler(void)
{
    ...
    if (__HAL_UART_GET_FLAG(&uart3.uart, UART_FLAG_IDLE))
    {
        ...
        uart3.rx_count += (UART3_RX_MAX - uart3.uart.RxXferCount);
