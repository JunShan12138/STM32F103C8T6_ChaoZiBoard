...
void OLED_W_SCL(uint8_t BitValue)
{
    ...
    HAL_GPIO_WritePin(OLED_GPIO_SCL_PORT, OLED_GPIO_SCL_PIN, (GPIO_PinState)BitValue);
...
//	GPIO_WriteBit(GPIOB, GPIO_Pin_9, (BitAction)BitValue);
    HAL_GPIO_WritePin(OLED_GPIO_SDA_PORT, OLED_GPIO_SDA_PIN, (GPIO_PinState)BitValue);
...
void OLED_GPIO_Init(void)
{
    ...
    /* 配置引脚 */
    GPIO_Init.Pin   = OLED_GPIO_SCL_PIN;
    GPIO_Init.Mode  = GPIO_MODE_OUTPUT_OD;
    GPIO_Init.Pull  = GPIO_NOPULL;
    GPIO_Init.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(OLED_GPIO_SCL_PORT, &GPIO_Init);
    
    GPIO_Init.Pin   = OLED_GPIO_SDA_PIN;
    GPIO_Init.Mode  = GPIO_MODE_OUTPUT_OD;
    GPIO_Init.Pull  = GPIO_NOPULL;
    GPIO_Init.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(OLED_GPIO_SDA_PORT, &GPIO_Init);
